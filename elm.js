...
var _user$project$Types$NewJava = function (a) {
	return {ctor: 'NewJava', _0: a};
};
var _user$project$Types$NewSQL = function (a) {
...
var _user$project$View$halfPageDiv = _rtfeldman$elm_css$Html_Styled$div(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
...
var _user$project$View$twoColumnWrapper = _rtfeldman$elm_css$Html_Styled$div(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
...
var _user$project$View$javaRed = A3(_rtfeldman$elm_css$Css$rgb, 217, 0, 23);
var _user$project$View$sqlBlue = A3(_rtfeldman$elm_css$Css$rgb, 33, 108, 192);
var _user$project$View$paragraphFont = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$View$largeTextArea = F3(
	function (borderColor, val, message) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$textarea,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(val),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(message),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
							{
...
var _user$project$View$headerFont = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$fontFamilies(
			{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$fontWeight(_rtfeldman$elm_css$Css$bolder),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$View$fonts = {header: _user$project$View$headerFont, paragraph: _user$project$View$paragraphFont};
var _user$project$View$columnHeader = function (c) {
	return _rtfeldman$elm_css$Html_Styled$h2(
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$color(c),
					_1: {
						ctor: '::',
						_0: _user$project$View$headerFont,
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$View$pageHeader = _rtfeldman$elm_css$Html_Styled$h1(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$color(_user$project$View$colors.primary),
					_1: {
						ctor: '::',
...
var _user$project$View$styledView = function (model) {
	return _user$project$View$pageWrapper(
		{
			ctor: '::',
			_0: _user$project$View$pageHeader(
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('requery'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$View$twoColumnWrapper(
					{
						ctor: '::',
						_0: _user$project$View$halfPageDiv(
							{
								ctor: '::',
								_0: A2(
									_user$project$View$columnHeader,
									_user$project$View$colors.sql,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text('SQL'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A3(_user$project$View$largeTextArea, _user$project$View$colors.sql, model.sql, _user$project$Types$NewSQL),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: _user$project$View$halfPageDiv(
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text('Java'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _user$project$View$view = function (_p0) {
	return _rtfeldman$elm_css$Html_Styled$toUnstyled(
		_user$project$View$styledView(_p0));
};
var _user$project$View$Fonts = F2(
	function (a, b) {
		return {header: a, paragraph: b};
	});
var _user$project$View$Colors = F5(
	function (a, b, c, d, e) {
...
var _user$project$Translate$toSQL = function (java) {
	var matches = A3(
		...
		_user$project$Translate$sqlInJava,
		java);
	var _p0 = matches;
	if (_p0.ctor === '::') {
		var groups = function (_) {
			return _.submatches;
		}(_p0._0);
		var withoutLeadingSpace = A2(_elm_lang$core$List$drop, 1, groups);
		var withoutMaybes = A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, withoutLeadingSpace);
		var _p1 = withoutMaybes;
		if (_p1.ctor === '[]') {
			return '';
		} else {
			return A2(_elm_lang$core$String$join, '', withoutMaybes);
		}
	} else {
		return '';
	}
};
var _user$project$Translate$translateLines = F3(
	function (transform, joiner, suffix) {
		return function (_p2) {
			return A3(
				_elm_lang$core$Basics$flip,
				F2(
...
var _user$project$Translate$toSQLLines = A3(_user$project$Translate$translateLines, _user$project$Translate$toSQL, '\n', '');
var _user$project$Translate$quote = '\"';
var _user$project$Translate$wrapInQuotes = function (s) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Translate$quote,
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				s,
				A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$Translate$quote))));
};
var _user$project$Translate$toJava = function (_p3) {
	return _user$project$Translate$wrapInQuotes(
		_elm_lang$core$String$trimRight(_p3));
};
		...
		switch (_p0.ctor) {
			case 'NewSQL':
				...
				return _elm_lang$core$Native_Utils.update(
					...
					{
						sql: _p1,
						java: _user$project$Translate$toJavaLines(_p1)
					});
			case 'NewJava':
				var _p2 = _p0._0;
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$init = A2(_user$project$Types$Model, '', '\" \";');
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Main$update})();
